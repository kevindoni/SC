...
[Unit]
Description=Ssh Websocket By KEVINDONI
...
wget -q -O /usr/local/bin/edu-ovpn https://raw.githubusercontent.com/kevindoni/SC/main/edu-op.py
...
[Unit]
Description=Ovpn Websocket By kevindoni
Documentation=https://t.me
After=network.target nss-lookup.target
