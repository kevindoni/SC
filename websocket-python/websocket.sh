...
cd
cd /usr/local/bin/
wget -O /usr/local/bin/ws-openssh https://raw.githubusercontent.com/${GitUser}/SC/main/${namafolder}/ws-openssh && chmod +x /usr/local/bin/ws-openssh 
wget -O /usr/local/bin/ws-dropbear https://raw.githubusercontent.com/${GitUser}/SC/main/${namafolder}/ws-dropbear && chmod +x /usr/local/bin/ws-dropbear
wget -O /usr/local/bin/ws-stunnel https://raw.githubusercontent.com/${GitUser}/SC/main/${namafolder}/ws-stunnel && chmod +x /usr/local/bin/ws-stunnel
wget -O /usr/local/bin/ws-ovpn https://raw.githubusercontent.com/${GitUser}/SC/main/${namafolder}/ws-ovpn && chmod +x /usr/local/bin/ws-ovpn
#
